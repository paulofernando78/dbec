...
export const lesson = {
  whiteboard: {
    title: "A2 Elementary",
    subtitle: "Unit 10 • Hobbies",
    descriptions: ["...", "..."],
    date: "...",
  },

  lessonCard: {
    lessonObjective: lessons.elementary.unitTen.lessonObjective,
    grammar: lessons.elementary.unitTen.grammar,
    vocabulary: lessons.elementary.unitTen.vocabulary,
  },
