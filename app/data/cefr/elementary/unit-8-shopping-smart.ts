...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: elementaryLessons.unitEight.lessonObjective,
    grammar: elementaryLessons.unitEight.grammar,
    vocabulary: elementaryLessons.unitEight.vocabulary,
  },
