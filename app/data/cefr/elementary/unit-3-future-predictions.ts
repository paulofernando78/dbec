...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: lessons.elementary.unitThree.lessonObjective,
    grammar: lessons.elementary.unitThree.grammar,
    vocabulary: lessons.elementary.unitThree.vocabulary,
  },
