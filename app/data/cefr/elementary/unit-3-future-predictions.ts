...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: elementaryLessons.unitThree.lessonObjective,
    grammar: elementaryLessons.unitThree.grammar,
    vocabulary: elementaryLessons.unitThree.vocabulary,
  },
