...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: elementaryLessons.unitSeven.lessonObjective,
    grammar: elementaryLessons.unitSeven.grammar,
    vocabulary: elementaryLessons.unitSeven.vocabulary,
  },
