...
export const lesson = {
  whiteboard: {
    title: "A2 Elementary",
    subtitle: "Unit 7 • Rules",
    descriptions: ["...", "..."],
    date: "...",
  },

  lessonCard: {
    lessonObjective: lessons.elementary.unitSeven.lessonObjective,
    grammar: lessons.elementary.unitSeven.grammar,
    vocabulary: lessons.elementary.unitSeven.vocabulary,
  },
