...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitThree.lessonObjective,
    grammar: upperIntermediateLessons.unitThree.grammar,
    vocabulary: upperIntermediateLessons.unitThree.vocabulary,
  },
