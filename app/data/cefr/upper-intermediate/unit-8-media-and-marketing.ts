...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitEight.lessonObjective,
    grammar: upperIntermediateLessons.unitEight.grammar,
    vocabulary: upperIntermediateLessons.unitEight.vocabulary,
  },
