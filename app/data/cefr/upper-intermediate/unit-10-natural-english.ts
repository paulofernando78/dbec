...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitTen.lessonObjective,
    grammar: upperIntermediateLessons.unitTen.grammar,
    vocabulary: upperIntermediateLessons.unitTen.vocabulary,
  },
