...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitTwo.lessonObjective,
    grammar: upperIntermediateLessons.unitTwo.grammar,
    vocabulary: upperIntermediateLessons.unitTwo.vocabulary,
  },
