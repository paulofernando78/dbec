...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitSeven.lessonObjective,
    grammar: upperIntermediateLessons.unitSeven.grammar,
    vocabulary: upperIntermediateLessons.unitSeven.vocabulary,
  },
