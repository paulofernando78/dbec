...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitSix.lessonObjective,
    grammar: upperIntermediateLessons.unitSix.grammar,
    vocabulary: upperIntermediateLessons.unitSix.vocabulary,
  },
