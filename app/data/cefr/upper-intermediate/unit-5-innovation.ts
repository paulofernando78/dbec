...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitFive.lessonObjective,
    grammar: upperIntermediateLessons.unitFive.grammar,
    vocabulary: upperIntermediateLessons.unitFive.vocabulary,
  },
