...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitNine.lessonObjective,
    grammar: upperIntermediateLessons.unitNine.grammar,
    vocabulary: upperIntermediateLessons.unitNine.vocabulary,
  },
