...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: upperIntermediateLessons.unitOne.lessonObjective,
    grammar: upperIntermediateLessons.unitOne.grammar,
    vocabulary: upperIntermediateLessons.unitOne.vocabulary,
  },
