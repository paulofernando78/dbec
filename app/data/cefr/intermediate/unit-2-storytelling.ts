...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitTwo.lessonObjective,
    grammar: intermediateLessons.unitTwo.grammar,
    vocabulary: intermediateLessons.unitTwo.vocabulary,
  },
