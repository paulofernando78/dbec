...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitFive.lessonObjective,
    grammar: intermediateLessons.unitFive.grammar,
    vocabulary: intermediateLessons.unitFive.vocabulary,
  },
