...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitOne.lessonObjective,
    grammar: intermediateLessons.unitOne.grammar,
    vocabulary: intermediateLessons.unitOne.vocabulary,
  },
