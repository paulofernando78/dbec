...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitTen.lessonObjective,
    grammar: intermediateLessons.unitTen.grammar,
    vocabulary: intermediateLessons.unitTen.vocabulary,
  },
