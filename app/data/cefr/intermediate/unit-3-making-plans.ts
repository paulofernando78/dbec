...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: lessons.intermediate.unitThree.lessonObjective,
    grammar: lessons.intermediate.unitThree.grammar,
    vocabulary: lessons.intermediate.unitThree.vocabulary,
  },
