...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitFour.lessonObjective,
    grammar: intermediateLessons.unitFour.grammar,
    vocabulary: intermediateLessons.unitFour.vocabulary,
  },
