...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitSix.lessonObjective,
    grammar: intermediateLessons.unitSix.grammar,
    vocabulary: intermediateLessons.unitSix.vocabulary,
  },
