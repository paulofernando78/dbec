...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitNine.lessonObjective,
    grammar: intermediateLessons.unitNine.grammar,
    vocabulary: intermediateLessons.unitNine.vocabulary,
  },
