...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitEight.lessonObjective,
    grammar: intermediateLessons.unitEight.grammar,
    vocabulary: intermediateLessons.unitEight.vocabulary,
  },
