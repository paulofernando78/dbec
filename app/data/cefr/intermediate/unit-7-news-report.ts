...
export const lesson = {
  ...
  lessonCard: {
    lessonObjective: intermediateLessons.unitSeven.lessonObjective,
    grammar: intermediateLessons.unitSeven.grammar,
    vocabulary: intermediateLessons.unitSeven.vocabulary,
  },
