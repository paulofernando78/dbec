...
export const thimbleweedPark = {
  ...
  sections: [
    {
      id: "part-one-the-meeting",
      title: "Part One • The Meeting",
    ...
    {
      id: "part-two-the-body",
      title: "Part Two • The Body",
      instruction: "Follow the steps below:",
      items: [
        ...
        {
          content: [
            "Explore the sewer entrance and pick up the hidden chainsaw.",
          ],
        },
        ...
        {
          content: [
            "Fix the broken hydrant with the help of the Pigeon Sisters.",
          ],
        },
        { content: ["Visit the diner and trigger Ransome's flashback."] },
        {
          content: [
            "Recover Ransome's joke book and complete his performance.",
          ],
        },
    ...
    {
      id: "part-three-the-arrest",
      title: "Part Three • The Arrest",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-four-the-will",
      title: "Part Four • The Will",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-five-the-reading",
      title: "Part Five • The Reading",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-six-the-factory",
      title: "Part Six • The Factory",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-seven-the-madness",
      title: "Part Seven • The Madness",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-eight-the-escape",
      title: "Part Eight • The Escape",
      instruction: "Follow the steps below:",
      items: [
    ...
    {
      id: "part-nine-the-deleting",
      title: "Part Nine • The Deleting",
      instruction: "Follow the steps below:",
      items: [
