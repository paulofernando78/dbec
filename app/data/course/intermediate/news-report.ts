...
export const intermediateNewsReport = {
    ...
    vocabularyCarousel: {
      ...
      words: [
        ...
        },
        {
          ...
          alt: "confirm",
          content: [
            { part: "confirm: ", type: "bold" },
            "to state that information is true",
          ],
        },
        {
          ...
          alt: "investigation",
          content: [
            { part: "investigation: ", type: "bold" },
            "an official attempt to discover facts",
          ],
        },
      ],
      matchingContent: shuffle([
        { as: "span", parts: ["headline"] },
        { as: "span", parts: ["witness"] },
        { as: "span", parts: ["confirm"] },
        { as: "span", parts: ["investigation"] },
      ]),
    },
    storyCarousel: {
      instruction:
  ...
  practice: completePractice({
    ...
    ["Three roads _____ closed after the storm.", "were", "did"],
    ["The new hospital _____ opened next month.", "will be", "will"],
    ["The suspect was _____ by police last night.", "arrested", "arrest"],
    ["More details _____ expected later today.", "are", "is"],
  ]),
  production: {
    task: {
