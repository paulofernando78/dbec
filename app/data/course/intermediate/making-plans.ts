export const intermediateMakingPlans = {
  ...
  introduction: {
    vocabularyCarousel: {
      ...
      matchingContent: [
        { as: "span", parts: ["arrangement"] },
        { as: "span", parts: ["intention"] },
        { as: "span", parts: ["deadline"] },
        { as: "span", parts: ["schedule"] },
      ],
      imgs: [
        {
          ...
          alt: "arrangement",
          content: [
            { part: "arrangement: ", type: "bold" },
            "a plan agreed with another person",
          ],
        },
        {
        ...
        },
        {
          ...
          alt: "schedule",
          content: [
            { part: "schedule: ", type: "bold" },
            "a fixed programme of times and events",
          ],
        },
      ],
    },
  ...
  presentation: {
    dialogue: {
      ...
      lines: [
        ...
        {
          speaker: "Ben",
          line: ["I'm meeting Carla at six. We're going to plan the project."],
        },
    ...
    scramble: {
      ...
      exercise: {
        items: [
          ...
          { prompt: "will / I / carry / that", answer: "I will carry that." },
        ],
      },
    },
  },
