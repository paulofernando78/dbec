export const intermediateGreenPlanet = {
  ...
  introduction: {
    vocabularyCarousel: {
      ...
      matchingContent: [
        { as: "span", parts: ["emissions"] },
        { as: "span", parts: ["renewable"] },
        { as: "span", parts: ["habitat"] },
        { as: "span", parts: ["recycle"] },
      ],
      imgs: [
        {
        ...
        },
        {
          ...
          alt: "renewable",
          content: [
            { part: "renewable: ", type: "bold" },
            "naturally replaced and not permanently used up",
          ],
        },
        {
        ...
        },
        {
          ...
          alt: "recycle",
          content: [
            { part: "recycle: ", type: "bold" },
            "to process waste so it can be used again",
          ],
        },
      ],
    },
        ...
        questions: [
          {
            ...
            options: [
              { option: "They reduce waste and save energy.", isCorrect: true },
              { option: "They create more raw materials.", isCorrect: false },
            ],
          },
          {
  ...
  presentation: {
    dialogue: {
      ...
      lines: [
        ...
        {
          speaker: "Iris",
          line: ["When we recycle materials, we reduce waste and save energy."],
        },
        {
          speaker: "Noah",
        ...
        {
          speaker: "Iris",
          line: ["It damages habitats and sometimes enters the food chain."],
        },
        {
          speaker: "Noah",
  ...
  languageFocus: {
    ...
    ccq: [
      ...
      { as: "p", parts: ["Does the result generally follow the condition?"] },
        ...
        questions: [
          {
            ...
            options: [
              ...
              { option: "will harmed", isCorrect: false },
            ],
          },
          {
            ...
            options: [
              ...
              { option: "would fall yesterday", isCorrect: false },
            ],
          },
          {
            ...
            options: [
              ...
              { option: "will using", isCorrect: false },
            ],
          },
          {
            ...
            options: [
              ...
              { option: "will not got", isCorrect: false },
            ],
          },
        ],
      },
