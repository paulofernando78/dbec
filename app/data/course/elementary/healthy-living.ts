...
export const elementaryHealthyLiving = {
  whiteboard: {
    title: "A2 Elementary",
    descriptions: ["If you sleep well, you feel better."],
  },
        ...
        ...{
          ...
          lines: [
            ...
            { speaker: "Maya", line: ["About five hours."] },
            {
              speaker: "Noah",
              line: [
                "That explains it. If you don't sleep enough, you feel tired.",
              ],
            },
          ...
          exercise: {
            questions: [
              ...
              },
              {
                ...
                options: [
                  {
                    option: "No, he is describing a general result.",
                    isCorrect: true,
                  },
                  {
                    option: "Yes, he is predicting tomorrow.",
                    isCorrect: false,
                  },
                ],
              },
    ...
    blocks: [
      ...
      },
      {
        ...
        value: [
          {
            as: "p",
            parts: ["Is this about one occasion or a general result?"],
          },
          { as: "p", parts: ["Which tense appears in both clauses?"] },
          {
            as: "p",
            parts: ["Can when replace if when the result is regular?"],
          },
          {
            as: "p",
            parts: ["Do we normally use will in a Zero Conditional?"],
          },
        ],
      },
    ],
