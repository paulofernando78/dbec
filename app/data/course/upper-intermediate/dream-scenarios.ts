export const upperIntermediateDreamScenarios = {
  whiteboard: {
    ...
    subtitle: "Dream Scenarios",
    descriptions: [
      "Explore imaginary present and future situations.",
  ...
  introduction: {
    vocabularyCarousel: {
      ...
      matchingContent: [
        { as: "span", parts: ["pursue"] },
        { as: "span", parts: ["relocate"] },
        { as: "span", parts: ["opportunity"] },
        { as: "span", parts: ["compromise"] },
      ],
      imgs: [
        {
          ...
          alt: "pursue",
          content: [
            { part: "pursue: ", type: "bold" },
            "to try to achieve a long-term aim",
          ],
        },
        {
        ...
        },
        {
          ...
          alt: "opportunity",
          content: [
            { part: "opportunity: ", type: "bold" },
            "a favourable situation that makes something possible",
          ],
        },
        {
