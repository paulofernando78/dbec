  ...
  gapSentences: [
    {
      before: "The wording ",
      answer: "suggests",
      after: " that the author remains unconvinced.",
    },
    {
      before: "The results are ",
      answer: ["arguably", "perhaps"],
      after: " less decisive than the headline claims.",
    },
    {
      before: "The committee ",
      answer: "stops short of",
      after: " recommending immediate implementation.",
    },
  ],
  scrambleSentences: [
    {
  ...
  introductionQuestions: [
    {
      ...
      options: [
        ...
        {
          option: "They emphasize different consequences of the same practice.",
          isCorrect: true,
        },
    ...
    },
    {
      ...
      options: [
        {
          option: "It adds a condition that may explain different outcomes.",
          isCorrect: true,
        },
  ...
  focusColumns: [
    {
      title: "Agreement",
      items: [
        "Both sources indicate...",
        "A point shared by both...",
        "Similarly...",
      ],
    },
    {
  ...
  gapSentences: [
    {
      before: "Both reports ",
      answer: "indicate",
      after: " that context influences the outcome.",
    },
    {
      before: "The first study reports higher autonomy, ",
      answer: "whereas",
      after: " the second emphasizes isolation.",
    },
    {
      before: "",
      answer: "Taken together",
      after: ", the findings point to a context-dependent effect.",
    },
  ],
  scrambleSentences: [
    {
  ...
  gapSentences: [
    {
      before: "",
      answer: "Admittedly",
      after: ", implementation would be expensive.",
    },
    {
      before: "",
      answer: "Nevertheless",
      after: ", the long-term savings justify a limited trial.",
    },
    {
      before: "The objection is relevant, but it ",
      answer: "overlooks",
      after: " the cost of inaction.",
    },
  ],
  scrambleSentences: [
    {
  ...
  introductionQuestions: [
    {
      ...
      options: [
        ...
        {
          option: "It distributes responsibility and reduces direct blame.",
          isCorrect: true,
        },
  ...
  gapSentences: [
    {
      ...
      after: " that option is attractive, although the legal risk remains.",
    },
    {
      before: "There ",
      answer: "may have been",
      after: " a misunderstanding about the deadline.",
    },
    {
      before: "",
      answer: "Would it be possible to",
      after: " review the wording before publication?",
    },
  ],
  scrambleSentences: [
    {
...
const academicPresentationsConfig: C1LessonConfig = {
  ...
  gapSentences: [
    {
      before: "I will begin by defining the issue before ",
      answer: "turning to",
      after: " its wider consequences.",
    },
    {
      before: "This finding is ",
      answer: "significant because",
      after: " it challenges the standard explanation.",
    },
    {
      before: "",
      answer: "Taken together",
      after: ", the three cases point to the same structural problem.",
    },
  ],
  scrambleSentences: [
    {
  ...
  comprehensionQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          option: "It preserves both the positive signal and the limitation.",
          isCorrect: true,
        },
  ...
  gapSentences: [
    {
      ...
      after: ", the pattern is promising but not conclusive.",
    },
    {
      before: "",
      answer: "Not quite",
      after: "; the data suggests a benefit rather than proving one.",
    },
    {
      before: "What this means ",
      answer: "in practice",
      after: " is that further testing is needed.",
    },
  ],
  scrambleSentences: [
    {
  ...
  comprehensionQuestions: [
    {
      ...
      options: [
        ...
        {
          option: "Its storytelling is effective but analytically limited.",
          isCorrect: true,
        },
  ...
  focusColumns: [
    ...
    },
    {
      ...
      items: [
        "ultimately...",
        "on balance...",
        "best suited to an audience that...",
      ],
    },
  ],
  notes: [
  ...
  gapSentences: [
    {
      before: "Its main ",
      answer: "strength",
      after: " lies in making the issue emotionally immediate.",
    },
    {
      before: "This is partly ",
      answer: "undermined by",
      after: " the narrow range of evidence.",
    },
    {
      before: "",
      answer: "On balance",
      after:
        ", it succeeds as an introduction rather than a definitive account.",
    },
  ],
  scrambleSentences: [
    {
...
const negotiationAndConsensusConfig: C1LessonConfig = {
  ...
  focusColumns: [
    ...
    },
    {
      ...
      items: [
        "We could agree provided that...",
        "If X, we would be willing to Y.",
  ...
  gapSentences: [
    {
      before: "We could accept the change ",
      answer: "provided that",
      after: " the review date remains fixed.",
    },
    {
      before: "A possible ",
      answer: "middle ground",
      after: " would be a limited regional pilot.",
    },
    {
      before: "What we appear to ",
      answer: "agree on",
      after: " is the need for reliable access.",
    },
  ],
  scrambleSentences: [
    {
...
const precisionAndNuanceConfig: C1LessonConfig = {
  ...
  gapSentences: [
    {
      before: "The preliminary pattern ",
      answer: "appears to",
      after: " support the hypothesis.",
    },
    {
      before: "The decline was ",
      answer: "likely to have been",
      after: " influenced by several factors.",
    },
    {
      before: "The new evidence ",
      answer: "strongly suggests",
      after: " that the earlier estimate was too low.",
    },
  ],
  scrambleSentences: [
    {
  ...
  practiceQuestions: [
    {
      ...
      options: [
        {
          option: "Sales rose, so the campaign definitely caused the increase.",
          isCorrect: false,
        },
        {
          option:
  ...
  gapSentences: [
    {
      before: "The observed ",
      answer: "change",
      after: " was an increase of nineteen percentage points.",
    },
    {
      before: "A plausible ",
      answer: "explanation",
      after: " is the introduction of reminders.",
    },
    {
      before: "A proportionate next ",
      answer: "step",
      after: " would be a controlled pilot.",
    },
  ],
  scrambleSentences: [
    {
